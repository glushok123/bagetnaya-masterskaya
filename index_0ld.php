...
?>
    <div id="main">
        ...
        <p>
            ...
            Если Вам нужен изысканный резной багет для живописи или рама для интерьера в стиле минимализма – ждем Вас в
            гости!
        </p>
        ...
        <ul>
            <li>
                <p><b>Багетные работы</b>.
                    ...
                    Изготовление подрамников для холстов. Изготовление фигурного паспарту для акварелей, пастелей и
                    графики.
                    ...
                    В ходе производства применяется натуральное дерево, алюминий и пластик. Багетная мастерская недорого
                    подберет для Вас красивое оформление!</p>
            </li>
            <li>
                <p><b>Широкоформатная печать на холсте</b> – лучшая идея для подарка.
                    Можно создать портрет на холсте с фотографии.
                    А если Вы хотите создать домашний уют с помощью картины, обратите внимание на такую услугу, как
                    интерьерная печать холста.
                    Изготовление картины под ключ снимет с Вас необходимость тратить время и силы на поиск подходящего
                    изображения и рамки.
                    Печать на холсте и бумаге - это прекрасная возможность воссоздать счастливые моменты семейной жизни
                    или получить репродукцию картины известного художника. </p>
            </li>
            <li>
                <p><b>Накатка на пенокартон</b> – востребованная услуга, под которой подразумевается прикрепление
                    полотна на твердую поверхность.
        ...
        <p>
            Наша Багетная мастерская в Москве предоставляет возможность подобрать оформление картины как бюджетного, так
            и премиального сегмента.
            Мы работаем с разными видами багета: пластиковый, деревянный и алюминиевый, а также с разными
            производителями:
            Россия, Китай, Италия, Испания и другие страны. Мы точно сможем подобрать для Вас подходящее оформление
            картины с учетом Вашего бюджета!
        </p>
        ...
        <p>
            ...
            Такая услуга позволить создать оформление картины исходя из освещения Вашего пространства, цветов стен,
        ...
        <p>
            ...
            В online-конструкторе багета можно не только найти подходящую раму, но и увидеть конечную стоимость Вашего
            заказа!
        </p>
