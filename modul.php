...
<body>
	<form name="form" onsubmit="return false;">
		Короткая сторона модулей: <input type="text" name="wid" onchange="formprice();" value="1000" autocomplete="off"> мм<br>
		Длинная сторона модулей: <input type="text" name="hei" onchange="formprice();" value="1000" autocomplete="off"> мм<br>
