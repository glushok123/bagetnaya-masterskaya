				...
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					<form>
						...
						<div class="form-outline mb-4">
							<input id='login_login' type="text" id="form3Example3" class="form-control form-control-lg" placeholder="Логин" />
						</div>

						<!-- Password input -->
						<div class="form-outline mb-3">
							<input id='login_passwd' type="password" id="form3Example4" class="form-control form-control-lg" placeholder="Пароль" />
						</div>

						<div class="text-center text-lg-start mt-4 pt-2">
							<button type="button" class="btn btn-primary btn-lg auth" style="padding-left: 2.5rem; padding-right: 2.5rem;">Вход</button>
							<hr>
						</div>
