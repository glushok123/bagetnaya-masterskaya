...
<?php
$keyw = "Готовые картины, купить Готовые картины, магазин готовых картин, Готовые картины интернет, Готовые картины интернет магазин ";
$titl = "Магазин готовых картин";
$desc = "Ищете где купить Готовые картины? Конечно в Багетной мастерской №1. Наш выбор готовых картин и производство на заказ помогут урасить Ваш итерьер.";
...
<div class="modal fade" id="add-in-cart" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <form action="">
                    ...
                    <div class="row text-center justify-content-center">
                        ...
                        <input id="phone" type="text" class="form-control text-center " style="max-width:500px;"
                               placeholder="(999) 999-99-99" required/>
                        <input id="email" type="text" class="form-control text-center " style="max-width:500px;"
                        ...
                        <input type="text" placeholder="Адрес доставки" class='hidden form-control text-center'
                               id='address'>
