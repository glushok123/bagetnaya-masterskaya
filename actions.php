...
?>
    ...
    <div class="container home_design">
        ...
        <div class="row text-center justify-content-center  mb-5">
            <a href="/сatalog-of-finished-works" class="button button-custom-index button-color-company-red fix-width-425 mob-fix-width-340 mb-3 color-white">смотреть галерею работ</a>
        </div>
