...
if ($_SERVER["REMOTE_ADDR"] == '' || $_SERVER["REMOTE_ADDR"] == '' || $_SERVER["REMOTE_ADDR"] == '127.0.0.1') {
    ...
    for ($jj = 0; $jj < (is_countable($chekcont) ? count($chekcont) : 0); $jj++) {
        ...
        if ($z[17] == 0) {
            ...
            if ($z[6] == 1) {
                $price3 = floor($s * 540);
                echo '<tr><td>Обычное стекло</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>540р.</td><td>' . $price3 . 'р.</td></tr>';
            }
            if ($z[6] == 2) {
                $price3 = floor($s * 1080);
                echo '<tr><td>Матовое стекло</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>1080р.</td><td>' . $price3 . 'р.</td></tr>';
            }
            if ($z[6] == 3) {
                $price3 = floor($s * 10400);
                echo '<tr><td>Стекло Антиблик</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>10400р.</td><td>' . $price3 . 'р.</td></tr>';
            }
            if ($z[6] == 4) {
                $price3 = floor($s * 1040);
                echo '<tr><td>Пластиковое стекло</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>1040р.</td><td>' . $price3 . 'р.</td></tr>';
            }
            if ($z[7] == 1) {
                $price4 = floor($s * 310);
                echo '<tr><td>Картон</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>274р.</td><td>' . $price4 . 'р.</td></tr>';
            }
            if ($z[7] == 2) {
                $price4 = floor($s * 1600);
                echo '<tr><td>Пенокартон 5мм</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>1600р.</td><td>' . $price4 . 'р.</td></tr>';
            }
            if ($z[7] == 3) {
                $price4 = floor($s * 2000);
                echo '<tr><td>Пенокартон 10мм</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>2000р.</td><td>' . $price4 . 'р.</td></tr>';
            }
            if ($z[7] == 4) {
                $price4 = floor($p * 400);
                echo '<tr><td>Подрамник</td><td>' . $p . ' м</td><td>400р.</td><td>' . $price4 . 'р.</td></tr>';
            }
            $price = $price1 + $price2 + $price3 + $price4;
            if ($price < 2280) {
                $price6 = 570;
            } else {
                $price6 = floor($price * 0.25);
            }
            ...
            if ($z[17] == 1) {
                echo '<tr><td>Накатка на пенокартон 5мм</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>1600р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 11) {
                echo '<tr><td>Накатка на пенокартон 10мм</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>2000р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 2) {
                echo '<tr><td>Натяжка на подрамник</td><td>' . $peri . ' м</td><td>400р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 3) {
                echo '<tr><td>Печать на холсте</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>3600р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 4) {
                echo '<tr><td>Печать на матовой бумаге</td><td>' . $lmax . ' пог. см</td><td>8р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 5) {
                echo '<tr><td>Печать на глянце бумаге</td><td>' . $lmax . ' пог. см</td><td>13р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 6) {
                echo '<tr><td>Покрытие лаком</td><td>' . round($s, 3) . ' м<sup>2</sup></td><td>9р.</td><td>' . $z[13] . 'р.</td></tr>';
            }
            if ($z[17] == 7) {
                if ($z[18] == 0) {
            ...
            if ($z[17] > 800) {
                ...
                echo '<tr><td>';
                if ($zs[0] == 8) {
                    echo 'Обычное зеркало, ';
                } else {
                    echo 'Зеркало Clear Vision, ';
                }
                if ($zs[1] == 1) {
                    echo '4мм';
                } else {
