    	...
    	<div class='actio'>
    		<div class='quest'>
    			<p>1/8. Откуда Вы узнали о нашей компании?</p>
    			<label><input type='radio' name='q1' value='Яндекс'> Яндекс<br></label>
    			<label><input type='radio' name='q1' value='Google'> Google<br></label>
    			<label><input type='radio' name='q1' value='Реклама на сайтах'> Реклама на сайтах<br></label>
    			<label><input type='radio' name='q1' value='Рекомендация знакомых'> Рекомендация знакомых<br></label>
    			<p><button onclick='quest(1);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>2/8. Как часто Вы пользуетесь услугами багетных мастерских?</p>
    			<label><input type='radio' name='q2' value='раз в месяц'> раз в месяц<br></label>
    			<label><input type='radio' name='q2' value='раз в год'> раз в год<br></label>
    			<label><input type='radio' name='q2' value='3-4 раза в год'> 3-4 раза в год<br></label>
    			<label><input type='radio' name='q2' value='постоянно пользуюсь'> постоянно пользуюсь<br></label>
    			<label><input type='radio' name='q2' value='первый и последний раз в жизни'> первый и последний раз в жизни<br></label>
    			<p><button onclick='quest(2);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>3/8. Для каких целей Вы обычно делаете заказы в Багетной мастерской?</p>
    			<label><input type='radio' name='q3' value='оформляю собственное творчество'> оформляю собственное творчество<br></label>
    			<label><input type='radio' name='q3' value='заказываю в качестве подарка для друзей и родственников'> заказываю в качестве подарка для друзей и родственников<br></label>
    			<label><input type='radio' name='q3' value='в связи с потребностями в таких услугах нашей компании'> в связи с потребностями в таких услугах нашей компании<br></label>
    			<p><button onclick='quest(3);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>4/8. Какой услугой нашей мастерской Вы воспользовались в этот раз?</p>
    			<label><input type='radio' name='q4' value='оформление картины или фотографии в багет'> оформление картины или фотографии в багет<br></label>
    			<label><input type='radio' name='q4' value='печать изображения на холсте'> печать изображения на холсте<br></label>
    			<label><input type='radio' name='q4' value='оформление вышивки (хэндмейда) в багет'> оформление вышивки (хэндмейда) в багет<br></label>
    			<label><input type='radio' name='q4' value='заказывал модульную картину'> заказывал модульную картину<br></label>
    			<label><input type='radio' name='q4' value='оформление иконы в багет'> оформление иконы в багет<br></label>
    			<label><input type='radio' name='q4' value='накатка на пенокартон'> накатка на пенокартон<br></label>
    			<p><button onclick='quest(4);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>5/8. Что Вам не понравилось в работе нашей мастерской?</p>
    			<label><input type='radio' name='q5' value='все отлично и все понравилось'> все отлично и все понравилось<br></label>
    			<label><input type='radio' name='q5' value='некачественно выполнен заказ'> некачественно выполнен заказ<br></label>
    			<label><input type='radio' name='q5' value='не слишком вежливое и внимательное отношение сотрудников'> не слишком вежливое и внимательное отношение сотрудников<br></label>
    			<label><input type='radio' name='q5' value='неудобное расположение мастерской'> неудобное расположение мастерской<br></label>
    			<label><input type='radio' name='q5' value='высокая цена на оказываемые услуги'> высокая цена на оказываемые услуги<br></label>
    			<p><button onclick='quest(5);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>6/8. Оцените по 5-ти балльной шкале удобство нашего сайта</p>
    			<label><input type='radio' name='q6' value='1'> 1<br></label>
    			<label><input type='radio' name='q6' value='2'> 2<br></label>
    			<label><input type='radio' name='q6' value='3'> 3<br></label>
    			<label><input type='radio' name='q6' value='4'> 4<br></label>
    			<label><input type='radio' name='q6' value='5'> 5<br></label>
    			<p><button onclick='quest(6);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>7/8. Воспользовались ли Вы скидкой предоставляемой на нашем сайте?</p>
    			<label><input type='radio' name='q7' value='да'> да<br></label>
    			<label><input type='radio' name='q7' value='нет'> нет<br></label>
    			<label><input type='radio' name='q7' value='что-то не заметил, где тут у вас дают скидку'> что-то не заметил, где тут у вас дают скидку<br></label>
    			<p><button onclick='quest(7);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>8/8. Готовы ли Вы еще раз воспользоваться услугами нашей Багетной мастерской?</p>
    			<label><input type='radio' name='q8' value='да'> да<br></label>
    			<label><input type='radio' name='q8' value='нет'> нет<br></label>
    			<label><input type='radio' name='q8' value='сначала проверю, как работают другие мастерские'> сначала проверю, как работают другие мастерские<br></label>
    			<p><button onclick='quest(8);'>Далее</button></p>
    		</div>
    		<div class='quest'>
    			<p>Спасибо</p>
    		</div>
		...
		if (strripos($file, 'pechat_na_holste/')) {
			...
			// else {$menu11.= '<a href="/pechat_na_holste/pechat_na_holste_cena.html" class="sublm unmark" > Цена печати на холсте</a> ';}
			...
			if (strripos($file, 'fotopechat_posterov_na_holste')) {
			...
			if (strripos($file, 'pechat_na_holste_s_imitatsiey_zhivopisi')) {
		...
		if (strripos($file, 'bagetnye_raboty/')) {
			...
			if (strripos($file, 'oformlenie_detskih_risunkov_v_baget')) {
			...
			if (strripos($file, 'televizor_v_bagete')) {
			...
			if (strripos($file, 'pechat_plakatov_A0_A1_A2')) {
			...
			if (strripos($file, 'pechat_plakatov_A4_A3')) {
			...
			if (strripos($file, 'pechat_posterov')) {
			...
			if (strripos($file, 'stilizacija_pod_zhivopis')) {
		...
		if (strripos($file, 'natyazhka_holsta/')) {
			...
			if (strripos($file, 'kartina_na_podramnike')) {
		...
		if (strripos($file, 'nakatka_na_penokarton/')) {
			...
			if (strripos($file, 'penokarton_5_10')) {
			...
			if (strripos($file, 'kupit_penokarton')) {
		...
		if (strripos($file, 'modulnye_kartiny/')) {
			...
			if (strripos($file, 'kupit_kartiny_dlya_interyera')) {
				$menu11 .= '<a href="/modulnye_kartiny/kupit_kartiny_dlya_interyera.html" class="sublm mark" > Купить картины для интерьера</a> ';
			} else {
				$menu11 .= '<a href="/modulnye_kartiny/kupit_kartiny_dlya_interyera.html" class="sublm unmark" > Купить картины для интерьера</a> ';
			}
			...
			if (strripos($file, 'modulnoe_panno_na_stenu')) {
				$menu11 .= '<a href="/modulnye_kartiny/modulnoe_panno_na_stenu.html" class="sublm mark" > Модульное панно на стену</a> ';
			} else {
				$menu11 .= '<a href="/modulnye_kartiny/modulnoe_panno_na_stenu.html" class="sublm unmark" > Модульное панно на стену</a> ';
			}
		} else {
		...
		if (strripos($file, 'ramki_dlya_kartin/')) {
			...
			if (strripos($file, 'ramki_dlya_vyshityh_kartin')) {
		...
		if (strripos($file, 'zerkala_v_bagete/')) {
			$menu2 .= '<a href="/zerkala_v_bagete/" class="lm mark"> Зеркала в багете</a> ';

			if (strripos($file, 'zerkalo_v_rame')) {
...
<noscript><div><img src="https://mc.yandex.ru/watch/60934651" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
		';
		}
		?>
