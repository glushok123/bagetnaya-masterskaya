...
<div class='actio'>
    <div class='quest'>
        ...
        <p>
            <button onclick='quest(1);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        ...
        <p>
            <button onclick='quest(2);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        <p>3/8. Для каких целей Вы обычно делаете заказы в Багетной мастерской?</p>
        <label><input type='radio' name='q3' value='оформляю собственное творчество'> оформляю собственное
            творчество<br></label>
        <label><input type='radio' name='q3' value='заказываю в качестве подарка для друзей и родственников'> заказываю
            в качестве подарка для друзей и родственников<br></label>
        <label><input type='radio' name='q3' value='в связи с потребностями в таких услугах нашей компании'> в связи с
            потребностями в таких услугах нашей компании<br></label>
        <p>
            <button onclick='quest(3);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        <p>4/8. Какой услугой нашей мастерской Вы воспользовались в этот раз?</p>
        <label><input type='radio' name='q4' value='оформление картины или фотографии в багет'> оформление картины или
            фотографии в багет<br></label>
        <label><input type='radio' name='q4' value='печать изображения на холсте'> печать изображения на
            холсте<br></label>
        <label><input type='radio' name='q4' value='оформление вышивки (хэндмейда) в багет'> оформление вышивки
            (хэндмейда) в багет<br></label>
        <label><input type='radio' name='q4' value='заказывал модульную картину'> заказывал модульную
            картину<br></label>
        ...
        <p>
            <button onclick='quest(4);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        <p>5/8. Что Вам не понравилось в работе нашей мастерской?</p>
        <label><input type='radio' name='q5' value='все отлично и все понравилось'> все отлично и все
            понравилось<br></label>
        <label><input type='radio' name='q5' value='некачественно выполнен заказ'> некачественно выполнен
            заказ<br></label>
        <label><input type='radio' name='q5' value='не слишком вежливое и внимательное отношение сотрудников'> не
            слишком вежливое и внимательное отношение сотрудников<br></label>
        <label><input type='radio' name='q5' value='неудобное расположение мастерской'> неудобное расположение
            мастерской<br></label>
        <label><input type='radio' name='q5' value='высокая цена на оказываемые услуги'> высокая цена на оказываемые
            услуги<br></label>
        <p>
            <button onclick='quest(5);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        ...
        <p>
            <button onclick='quest(6);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        ...
        <label><input type='radio' name='q7' value='что-то не заметил, где тут у вас дают скидку'> что-то не заметил,
            где тут у вас дают скидку<br></label>
        <p>
            <button onclick='quest(7);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        ...
        <label><input type='radio' name='q8' value='сначала проверю, как работают другие мастерские'> сначала проверю,
            как работают другие мастерские<br></label>
        <p>
            <button onclick='quest(8);'>Далее</button>
        </p>
    </div>
    <div class='quest'>
        <p>Спасибо</p>
...
<h3>Наши акции</h3>
<div class="actio">У Вас персональная выставка? Посмотрите наше предложение по <a href="/bagetnye_raboty/obramlenie/"
                                                                                  class="t2"> обрамлению работ багетными
        рамками на СПЕЦИАЛЬНЫХ УСЛОВИЯХ</a></div>
