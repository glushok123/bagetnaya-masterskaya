...
<div class="container home_design">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 section-text">
            ...
            <p>Данный вид работы занимает больше времени на изготовление, однако результат впечатляет своим объемом и фактурой! Смотрите примеры прорисовки в <a href="/%d1%81atalog-of-finished-works">нашей галерее работ!</a> </p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 section-text">
            ...
            <p style="color: #a3080d;">Ознакомиться со стоимостью услуги прорисовки и другими видами багетных услуг Вы можете <a href="/prices_for_print_and_canvas">здесь</a> </p>
