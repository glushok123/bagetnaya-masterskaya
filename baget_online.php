...
<div id="bmenu" style="display: none; z-index: 9999999999999">
    ...
    <div class="baget-conteiner container-fluid" onscroll="scrollingBmenu()">
        <div class='row justify-content-center' id="addBagetBlock">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Багет подобранный искусственным интеллектом на основании
                    спектрального анализа изображения</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-close-custom" data-bs-dismiss="modal">Закрыть
                </button>
            </div>
        </div>
    </div>
