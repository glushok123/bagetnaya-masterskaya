<section>
    <div class='container my-5'>
        ...
        <div class="footer-see-also text-center">
            ...
            <span class='mx-3'><a href="/nakatka_na_penokarton/"
                                  class="url text-nowrap"> Накатка на пенокартон</a></span>
            <span class='mx-3'><a href="/pechat_na_penokartone"
                                  class="url text-nowrap"> Печать на пенокартоне</a></span>
            ...
            <span class='mx-3'><a href="/ordena_i_medali"
                                  class="url text-nowrap"> Панно для наград и орденов</a></span>
