    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form action="" style="padding:15px;">
                    <div class="row text-center justify-content-center">
                        ...
                        <div class="form-floating mb-3">
                            <input id="user-name" type="text" class="form-control text-center" placeholder="Фамилия Имя"
                                   style="max-width:500px;" required>
                            <label for="floatingInput" style='left:20px;'>Фамилия Имя</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input id="phone" type="text" class="form-control text-center phone-valid"
                                   placeholder="+7 (999) 999-99-99" style="max-width:500px;" required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  button-color-company-red" id='send-order' style='color:white;'>
                    Отправить заявку
                </button>
            </div>
        </div>
