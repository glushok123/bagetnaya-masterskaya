                ...
                <div class="modal-body">
                    <form action="" style="padding:15px;">
                        <div class="row text-center justify-content-center">
                            ...
                            <input id="phone" type="text" class="form-control text-center " style="max-width:500px;" placeholder="+7 (999) 999-99-99" required />
                            ...
                            <div class="form-check text-start">
                                <input class="form-check-input" type="radio" name="email" id="exampleRadios1" value="Позвоните мне" checked>
                            ...
                            <div class="form-check text-start">
                                <input class="form-check-input text-start" type="radio" name="email" id="exampleRadios2" value="Напишите мне в whatsapp">
