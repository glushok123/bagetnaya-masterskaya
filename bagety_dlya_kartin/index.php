...
?>
    ...
    <div class="container " id="page">
        ...
        <div class="row text-center mt-5 mb-3">
            ...
            <h5>Первое и самое важное – определите стиль картины! Условно можно разделить все виды прикладного искусства
                на следующие направления: </h5>
            <p>
        ...
        <div class="row m-3">
            ...
            <div class="col-12 col-md-8">
                <h5>Стекло и другие вспомогательные материалы</h5>
                <p>
        ...
        <div class="row m-3">
            <h5>Багетная рама – несущая конструкция </h5>
            <p>
        ...
        <div class="row m-3">
            <h5>Паспарту – декоративный цветной картон и не только </h5>
            <p>
